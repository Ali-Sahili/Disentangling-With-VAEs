...
class SimpleDots(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        Args:
            index (int): Index
        Returns:
            tuple: (sample, target) where sample is the image, and target is the x, y coordinates of the dot in the image.
        """
...
if __name__ == '__main__':
    dataset = SimpleDots(image_size=(64, 64), circle_radius=8, num_images=100)
